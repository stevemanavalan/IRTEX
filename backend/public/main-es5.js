...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function AppComponent_div_27_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_div_27_Template_input_click_3_listener() {
      ...
      _createClass(AppComponent, [{
        ...
        value: function fileChange(event) {
          ...
          if (event.target.files.length > 0) {
            var file = event.target.files[0]; //addinputValue: string = ""
        ...
        value: function persistId(item) {
          ...
          queryImage.append('file', this.uploadForm.get('file').value); //console.log(this.imageForm);
        ...
        value: function displayChart(item) {
          this.description = "The selected image matches ".concat(item.color, " percentage with color, shape and texture of the query image.");
          console.log(item);
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 30,
      vars: 6,
      consts: [[1, "height100"], ["enctype", "multipart/form-data", 3, "formGroup"], [1, "header"], [1, "label-group"], [1, "header-label"], [1, "sub-header-label"], [1, "search-outer"], [1, "search-container", "box-shadow"], ["src", "/assets/images/search.svg", "alt", "search"], ["class", "image-items ", 4, "ngFor", "ngForOf"], [1, "btn-group"], [1, "input-container"], ["type", "file", "name", "file", "id", "file", "multiple", "", "accept", "image/*", 1, "file-input", 3, "change"], ["for", "file"], ["src", "/assets/images/upload.svg"], [1, "search-btn", 3, "click"], [1, "results-count"], [1, "count-circle"], ["class", "row-info", 4, "ngIf"], [1, "results-container"], [1, "image-row"], ["class", "image-item box-shadow", 4, "ngFor", "ngForOf"], ["class", "image-desc box-shadow", 4, "ngIf"], [1, "image-items"], [1, "row-info"], [1, "image-item", "box-shadow"], [1, "image"], [1, "image-button"], ["type", "button", "value", "Explain", 1, "btn", "btn-primary", "btn-block", "explain-btn", 3, "click"], [1, "circles"], [1, "image-desc", "box-shadow"], [1, "desc-label"], [1, "description"], ["id", "pieChart", 1, "chart-container"]],
    ...
    var UploadserviceService = /*#__PURE__*/function () {
      ...
      _createClass(UploadserviceService, [{
        ...
        value: function runscript(formData) {
          return this.http.post('runscript', formData, {
            observe: "response",
            responseType: 'json'
          });
        }
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! E:\OVGU\Sem2_Summer2020\Subjects\Project\deployments\frontend\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
